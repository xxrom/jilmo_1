...
bluebird__WEBPACK_IMPORTED_MODULE_4___default.a.promisifyAll(redis__WEBPACK_IMPORTED_MODULE_3___default.a.RedisClient.prototype);
bluebird__WEBPACK_IMPORTED_MODULE_4___default.a.promisifyAll(redis__WEBPACK_IMPORTED_MODULE_3___default.a.Multi.prototype);
const server = new koa__WEBPACK_IMPORTED_MODULE_0___default.a();
const redis = redis__WEBPACK_IMPORTED_MODULE_3___default.a.createClient();
const PORT = process.env.PORT;
redis.set('test', 'redis HELLO');
server.use(koa_morgan__WEBPACK_IMPORTED_MODULE_1___default()('tiny')).use(async ctx => {
...
module.exports = __webpack_require__(/*! /Users/nikita/js/tests/jilmo_1/backend/src/index.js */"./src/index.js");
